...
export default function layout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <div className='container flex justify-between items-start gap-6'>
      <div className='flex flex-col gap-10 lg:w-1/5 md:w-5/5 max-h-96 bg-zinc-800 rounded-md p-4'>
